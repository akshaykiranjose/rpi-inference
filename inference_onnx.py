...
IMG_DIR_PATH = r"/mnt/c/Users/Akshay/Desktop/Coursework/Semester 3/MTP/github/inference/sample_data" #set the path to the directory with the samples
IMAGENET_CLASS_PATH = r"/mnt/c/Users/Akshay/Desktop/Coursework/Semester 3/MTP/github/inference/imagenet_classes.txt" #file that lists imagenet classes to index
MODEL_ONNX_PATH = r"/mnt/c/Users/Akshay/Desktop/Coursework/Semester 3/MTP/onnx-get-started/vit_b_32.onnx"
...
def preprocess_image(image_path: Path,
    ...
    # resizes to (resize_sz, resize_sz)
    image = image.resize((resize_sz, resize_sz), Image.BILINEAR)
    # centre-crop to (crop_sz, crop_sz)
    image = image.crop((resize_sz//2-crop_sz//2, resize_sz//2-crop_sz//2, resize_sz//2+crop_sz//2, resize_sz//2+crop_sz//2))
...
def process_image(ort_session, image_path, imagenet_categories):
    ...
    image_np = preprocess_image(image_path, resize_sz=256, crop_sz=224)
